...
def reference(host_array: numpy.ndarray, device_array: pycuda.driver.DeviceAllocation,
              label: str = None) -> vecpy.base.Array:
    """
    ...
    """
    return vecpy.base.Array(host_array, device_array, label)
